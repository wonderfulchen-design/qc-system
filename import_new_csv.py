...
print("="*70)
print("用新的 CSV 文件重新导入 product_batches 表")
print("="*70)

# 1. 读取 CSV 文件
print("\n[1/3] 读取 CSV 文件...")
file_path = r'C:\Users\Administrator\.openclaw\qqbot\downloads\波次号工厂货品编码_1774500912637.csv'

# 尝试 UTF-8 编码
df = pd.read_csv(file_path, encoding='utf-8-sig')
print(f"  [OK] 使用 UTF-8 编码读取成功")
...
# 检查浩茂
if '浩茂' in factories.index:
    print(f"  ✅ 浩茂工厂：{factories['浩茂']} 条")
else:
    print(f"  ❌ 浩茂工厂：不存在")
